...
const std::map<std::string, CreatorFunction> get_supported_ops() {
    return {
        ...
        {"Assert", CreatorFunction(translate_assert_op)},
        ...
        {"LookupTableInsert", CreatorFunction(translate_lookup_table_insert_op)},
        {"LookupTableInsertV2", CreatorFunction(translate_lookup_table_insert_op)},

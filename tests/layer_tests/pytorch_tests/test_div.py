...
class TestDiv(PytorchLayerTest):
    ...
    @pytest.mark.parametrize(("input_array", "other_array"), [
        [np.random.rand(5, 5), np.random.uniform(low=0.1, high=1.0, size=(1))],
        [np.random.rand(5, 5, 1), np.random.uniform(low=0.1, high=1.0, size=(1))],
        [np.random.rand(1, 1, 5, 5), np.random.uniform(low=0.1, high=1.0, size=(1))],
        [np.random.rand(5, 5, 1), np.random.uniform(low=0.1, high=1.0, size=(5, 1))],
        [np.random.rand(5, 5), np.random.uniform(low=0.1, high=1.0, size=(5, 5))],
